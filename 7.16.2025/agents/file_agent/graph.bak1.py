...
pages_split = text_splitter.split_documents(
    pages)  # We now apply this to our pages
...
def retriever_tool(query: str) -> str:
    """
    This tool searches and returns the information from the patient PDF files based on the query provided.
    If the query is empty or asks for all information, this tool will retrieve all documents from the vector store.
    """
...
system_prompt = """
You are an intelligent medical AI assistant who answers questions about patient health data based on the PDF documents loaded into your knowledge base.
