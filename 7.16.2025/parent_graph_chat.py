...
async def on_chat_start():
    ...
    welcome_message = """# Welcome to the AI Medical Assistant! 🏥

I'm here to help you with:

## 📄 **Document Analysis**
- Upload PDF files for detailed analysis
...
- Research health conditions and treatments
- Access current medical literature
...
**To get started:**
1. 📎 Attach PDF files for document analysis
2. 💬 Ask me any question
3. 🔍 I'll automatically choose the best approach to help you
